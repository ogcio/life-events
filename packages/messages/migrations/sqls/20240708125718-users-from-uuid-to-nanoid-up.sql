...
ALTER COLUMN id SET DATA TYPE varchar(12) USING SUBSTRING(id::text, 0, 12),
...
ALTER COLUMN user_id SET DATA TYPE varchar(12) USING SUBSTRING(21::text, 0, 12);
...
ALTER COLUMN created_by_user_id SET DATA TYPE varchar(12) USING SUBSTRING(created_by_user_id::text, 0, 12),
ALTER COLUMN organisation_id SET DATA TYPE varchar(21) USING SUBSTRING(organisation_id::text, 0, 21);
