...
ALTER COLUMN organisation_id SET DATA TYPE uuid USING organisation_id::uuid;
...
ALTER TABLE users
ALTER COLUMN user_profile_id SET DATA TYPE uuid USING user_profile_id::uuid,
ALTER COLUMN id SET DATA TYPE uuid USING id::uuid,
ALTER COLUMN importer_organisation_id SET DATA TYPE uuid USING importer_organisation_id::uuid;
...
ALTER COLUMN created_by_user_id SET DATA TYPE uuid USING created_by_user_id::uuid,
ALTER COLUMN organisation_id SET DATA TYPE uuid USING organisation_id::uuid;
